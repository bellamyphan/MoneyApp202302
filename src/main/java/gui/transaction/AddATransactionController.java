...
public class AddATransactionController {
    ...
    private void reviewButtonOnAction() {
        ...
        idTextField.setText(new TransactionHandler(transactions).getAutoGeneratedId().toString());
    ...
    private void initializeNoteComboBox() {
        ObservableList<String> stringObservableList = FXCollections.observableArrayList();
        List<TransactionObject> filteredTransactions =
                new TransactionHandler(transactions).getTransactions(selectedType);
